...
export function DisclaimerFooter() {
  return (
    <footer style={{ marginTop: "64px", borderTop: "1px solid var(--border)", background: "var(--bg)" }}>
      <style>{`
        .footer-link { color: var(--text-3); font-size: 0.8rem; text-decoration: none; transition: color 0.15s; }
      ...
      <div className="max-w-7xl mx-auto" style={{ padding: "48px 24px 40px" }}>
        <div className="footer-grid">
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <a href="mailto:support@deepputs.com" className="footer-link">support@deepputs.com</a>
            </div>
          </div>
        </div>
      </div>
