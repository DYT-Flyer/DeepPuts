  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6" style={{ background: "var(--bg)" }}>
      <div className="mb-12 text-center">
        ...
        <h1 className="text-4xl font-bold tracking-tight mb-4 text-white">Upgrade to DeepPuts Pro</h1>
        <p className="text-lg" style={{ color: "var(--text-2)" }}>Unlock real-time AI analysis, infinite history, and high-conviction alerts.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        <div className="rounded-2xl p-8" style={{ background: "var(--surface)", border: "1px solid var(--border)" }}>
          ...
          <button disabled className="w-full py-3 rounded-xl font-medium text-sm transition-all" style={{ background: "var(--surface-2)", color: "var(--text-3)", cursor: "not-allowed" }}>
            Current Plan
          </button>
        </div>
